...
saveRDS(fit_diffuse, "fit_diffuse.rds")
saveRDS(fit_weak, "fit_weak.rds")
saveRDS(fit_info,  "fit_info.rds")
```

```{r echo = FALSE}
fit_diffuse <- readRDS("fit_diffuse.rds")
fit_weak    <- readRDS("fit_weak.rds")
fit_info    <- readRDS("fit_info.rds")
```
...
saveRDS(fit_psi_broad, "fit_psi_broad.rds")
saveRDS(fit_psi_low,   "fit_psi_low.rds")
saveRDS(fit_psi_high,  "fit_psi_high.rds")
```

```{r echo = FALSE}
fit_psi_broad <- readRDS("fit_psi_broad.rds")
fit_psi_low   <- readRDS("fit_psi_low.rds")
fit_psi_high  <- readRDS("fit_psi_high.rds")
```
